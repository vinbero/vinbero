...
int tucube_IBase_init(struct tucube_Config* config, struct tucube_Module_List* moduleList, void* args[]); \
...
int (*tucube_IBase_init)(struct tucube_Config*, struct tucube_Module_List*, void*[]); \
