...
int (*tucube_IBase_init)(struct tucube_Module_Config*, struct tucube_Module_List*, void*[]); \
int (*tucube_IBase_destroy)(struct tucube_Module*);                                          \
int (*tucube_IBase_tlInit)(struct tucube_Module*, struct tucube_Module_Config*, void*[]);    \
