...
int (*tucube_tcp_epoll_Module_init)(struct tucube_Module*, struct tucube_ClData_List*, void*[]); \
int (*tucube_tcp_epoll_Module_service)(struct tucube_Module*, struct tucube_ClData*, void*[]);   \
int (*tucube_tcp_epoll_Module_destroy)(struct tucube_Module*, struct tucube_ClData*)
